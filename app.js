...
// "this" refers to the newly constructed Student.

// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" refers to the global window object.

// 3. Explain why "this" is different when an arrow function is used.
// In regular functions, "this" refers to the object that called the function. With arrow functions "this" does not reset and will always represent the global window object. This is why you do not use an arrow function when using a constructor. Additional resource used: w3schools - https://www.w3schools.com/js/js_arrow_function.asp
